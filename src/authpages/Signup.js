  ...
  return (
    <div  className=" bg-primary flex flex-col items-center min-h-screen pt-6 sm:justify-center sm:pt-0 ">
      ...
      <div>
            ...
            <div className="w-full mb-16 px-6 py-4 mt-6 overflow-hidden bg-white shadow-md sm:max-w-lg sm:rounded-lg">
                <form className="signupForm" onSubmit={handleSubmit}>
                    <div>
                        <label
                            htmlFor="name"
                        ...
                        <div className="flex flex-col items-start">
                            <input
                                ...
                                onChange={(e) => setFirstName(e.target.value)}
                                required
                                className="block w-full mt-1 py-2 px-5 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                            />
                        </div>
                    </div>
                    <div className="mt-4">
              ...
              to="/login">
                <button styles={`mt-10`} className="text-purple-600" >Login</button>
            </NavLink>
                    </span>
                </div>
